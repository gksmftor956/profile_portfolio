...
/*                 $('.videoLinkBtn').on({
                ...
                $('.videoGalleryP').on({
                    mouseenter: function(){
                        $(this).find('.galleryVideo').get(0).pause();
                    },
                    mouseleave: function(){
                        $(this).find('.galleryVideo').get(0).play();
                    }
                });
                ...
                var t = [0,0,0,0,0,0]; //클릭상태를 기억하는 배열
                    ...
                    //순서 - 1
                    //필터는 로딩시 모든 배열안에
                    //li 목록(인덱스값) 저장 more가 아닌 것 저장, all[]     ... rejuvenate[]
                    ...
                    function fillterFn(){
                        ...
                        for(i=0; i<$('.videoGallery').length; i++){
                            ...
                            if( $('.videoGallery').eq(i).data('id') !== 'more'  ){
                                ...
                                galN = all.length; //로딩 시 기본값 12개 나와야하기에
                                ...
                                if( $('.videoGallery').eq(i).data('class').indexOf('rejuvenate') >= 0 ){
                                   ...
                                   //그리고 all 을 클릭하면 all 목록 12개와 추가목록이 나타나야 된다.
                            else { //more 데이터 : 더보기
...
/*                         console.log('all 갤러리개수 : ' + all.length);
                        ...
                        modN = Math.ceil(galN % colN);  //나머지 개수 = 총개수 % 칸수
...
/*                         console.log('빈칸 개수 : ' + blnN ); */
                    ...
                    $('.loadMore_wrap').show(); //로드모어 버튼 박스 보이기
                            ...
                            setTimeout(function(){
                                ...
                                if( z==0 ){ //all
                                    for(var i in allMore){
                                        ...
                                        all.push(allMore[i]); //클릭 시 추가 목록
                                        
                                     }
                                     galN = all.length;

                                     //나머지 버튼 5개의 필터도 추가 해줘야한다.
                                     //배열만
                                     //그래야 갤러리버튼 클릭시 배열에 추가된 목록이 나타난다
                                     for( i=0; i<19; i++ ){
                                        for( j=0; j<5; i++ ){ //0 ~ 4
                                    ...
                                    for(var i in beachMore){
                                        ...
                                        all.push(beachMore[i]); //클릭 시 추가 목록
                                    ...
                                    for(var i in cityMore){
                                        ...
                                        all.push(cityMore[i]); //클릭 시 추가 목록
                                        city.push(cityMore[i]);
                                    ...
                                    for(var i in mountainMore){
                                        ...
                                        all.push(mountainMore[i]); //클릭 시 추가 목록
                                        mountain.push(mountainMore[i]);
                                    ...
                                    for(var i in alternativeMore){
                                        ...
                                        all.push(alternativeMore[i]); //클릭 시 추가 목록
                                        alternative.push(alternativeMore[i]);
                                    ...
                                    for(var i in rejuvenateMore){
                                        ...
                                        all.push(rejuvenateMore[i]); //클릭 시 추가 목록
                                        rejuvenate.push(rejuvenateMore[i]);
                                ...
                                resizeFn(); //loadMore 버튼 반응형 호출

                            },1500);  //원인 1.5초 후에 실행 되어서 setTimeout 안에서
                                      //반응형 호출 실행 연동
                        ...
                        if( t==0 ){
                            ...
                            $('.footNavBtn').on({
                                click:  function(){
                                    ...
                                    //아이콘 변경
                                    if( $(this).children('i').hasClass('fa fa-angle-down') ){ //true
                                        $('.footNavBtn').children('i').attr('class','fa fa-angle-down');
